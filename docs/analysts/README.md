...
| 項目           | US 市場                                                                                      | TW 市場                                  |
| -------------- | -------------------------------------------------------------------------------------------- | ---------------------------------------- |
| 核心波動       | VIX（VVIX 僅在 VIX 快速拉升時有條件使用）                                                    | 臺指選擇權波動率指數（台版 VIX）         |
| 核心選擇權     | Put/Call Ratio（Volume + OI）、ATM IV、IV Term Structure、IV Skew（RR/BF）                  | 臺指選擇權 PCR（成交量 + OI 兩種口徑）   |
| 輔助資金流     | —                                                                                            | USD/TWD 匯率趨勢                         |
| 市場行為 proxy | 近 5 日實現波動率                                                                            | 近 5 日實現波動率                        |
...
- [市場心理分析師設計筆記（討論保留）](./psychology-design-notes.md)
